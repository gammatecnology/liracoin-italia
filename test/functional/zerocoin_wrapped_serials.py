...
from fake_stake.base_test import Liracoin_FakeStakeTest

class zLITwrappedSerialsTest(Liracoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zLITs..." % DENOM_TO_USE)
