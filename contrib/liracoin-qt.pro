...
RESOURCES += src/qt/liracoin.qrc src/qt/liracoin_locale.qrc

TRANSLATIONS += src/qt/locale/liracoin_bg.ts \
                src/qt/locale/liracoin_de.ts \
                src/qt/locale/liracoin_en.ts \
                src/qt/locale/liracoin_es.ts \
                src/qt/locale/liracoin_fi.ts \
                src/qt/locale/liracoin_fr.ts \
                src/qt/locale/liracoin_it.ts \
                src/qt/locale/liracoin_ja.ts \
                src/qt/locale/liracoin_pl.ts \
                src/qt/locale/liracoin_pt.ts \
                src/qt/locale/liracoin_ru.ts \
                src/qt/locale/liracoin_sk.ts \
                src/qt/locale/liracoin_sv.ts \
                src/qt/locale/liracoin_vi.ts \
                src/qt/locale/liracoin_zh_CN.ts \
                src/qt/locale/liracoin_zh_TW.ts
