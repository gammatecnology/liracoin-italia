Contributing to Liracoin Core
============================

The Liracoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/liracoin-project/liracoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Liracoin Core project, and is not to be
confused with overall Liracoin Network Protocol consensus changes.

Whether a pull request is merged into Liracoin Core rests with the project merge
...
Patches that change Liracoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Liracoin consensus, it must have been
...
The project leader is the release manager for each Liracoin Core release.
