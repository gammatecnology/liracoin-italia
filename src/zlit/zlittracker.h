...
#ifndef Liracoin_ZLITTRACKER_H
#define Liracoin_ZLITTRACKER_H
...
public:
    CzLITTracker(std::string strWalletFile);
    ~CzLITTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzLITWallet* zLITWallet = NULL);
