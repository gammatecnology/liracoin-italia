...
#ifndef Liracoin_ZLITWALLET_H
#define Liracoin_ZLITWALLET_H
...
public:
    CzLITWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLIT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLIT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
