...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Liracoin Core liracoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  liracoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded liracoin transaction") + "\n" +
                               "  liracoin-tx [options] -create [commands]   " + _("Create hex-encoded liracoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded liracoin transaction
