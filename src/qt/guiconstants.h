...
/* Liracoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Liracoin"
#define QAPP_ORG_DOMAIN "liracoin.org"
#define QAPP_APP_NAME_DEFAULT "Liracoin-Qt"
#define QAPP_APP_NAME_TESTNET "Liracoin-Qt-testnet"
