                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Liracoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and liracoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLIT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Liracoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Liracoin Core"));
    ...
    openAction->setStatusTip(tr("Open a Liracoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Liracoin Core help message to get a list with possible Liracoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Liracoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Liracoin Core"); // default title
