...
// Wallet
    ...
    if (settings.contains("nAnonymizeLiracoinAmount"))
        SoftSetArg("-anonymizeliracoinamount", settings.value("nAnonymizeLiracoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in liracoin.cpp during shotdown to also remove the window positions
