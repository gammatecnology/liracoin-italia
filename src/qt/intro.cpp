...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Liracoin Core"),
     ...
     * override -datadir in the liracoin.conf file in the default data directory
     * (to be consistent with liracoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
