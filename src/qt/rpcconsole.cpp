                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLITPathCustom = GetArg("-zlitbackuppath", "");
    ...
    if(!strzLITPathCustom.empty()) {
        ui->wallet_customzlitbackuppath->setText(QString::fromStdString(strzLITPathCustom));
        ui->wallet_customzlitbackuppath_label->setVisible(true);
        ui->wallet_customzlitbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLITPathCustom.empty()) && nCustomBackupThreshold > 0) {
