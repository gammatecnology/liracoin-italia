...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total liracoin balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zLITsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zLIT denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zLIT denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zLIT denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zLIT denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zLIT denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zLIT denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zLIT denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zLIT denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zLIT denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in liracoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in liracoin/kb\n"
    ...
    UniValue zlitObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zlitObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zlitObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zLITsupply", zlitObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given liracoin address.\n"

            "\nArguments:\n"
            "1. \"liracoinaddress\"     (string, required) The liracoin address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"liracoinaddress\", (string) The liracoin address validated\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are liracoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) liracoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"liracoinaddress\"  (string, required) The liracoin address to use for the signature.\n"
