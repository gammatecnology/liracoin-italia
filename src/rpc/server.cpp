...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Liracoin features */
        {"liracoin", "listmasternodes", &listmasternodes, true, true, false},
        {"liracoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"liracoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"liracoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"liracoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"liracoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"liracoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"liracoin", "masternodedebug", &masternodedebug, true, true, false},
        {"liracoin", "startmasternode", &startmasternode, true, true, false},
        {"liracoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"liracoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"liracoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"liracoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"liracoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"liracoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"liracoin", "preparebudget", &preparebudget, true, true, false},
        {"liracoin", "submitbudget", &submitbudget, true, true, false},
        {"liracoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"liracoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"liracoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"liracoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"liracoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"liracoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"liracoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"liracoin", "checkbudgets", &checkbudgets, true, true, false},
        {"liracoin", "mnsync", &mnsync, true, true, false},
        {"liracoin", "spork", &spork, true, true, false},
        {"liracoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzlitseed", &getzlitseed, false, false, true},
        {"zerocoin", "setzlitseed", &setzlitseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzlit", &searchdzlit, false, false, true},
        {"zerocoin", "dzlitstate", &dzlitstate, false, false, true},
...
{
    return "> liracoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11949/\n";
}
