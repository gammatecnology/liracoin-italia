...
/**
 * Liracoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZlitSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzlitseed(const UniValue& params, bool fHelp);
extern UniValue getzlitseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzlit(const UniValue& params, bool fHelp);
extern UniValue dzlitstate(const UniValue& params, bool fHelp);
